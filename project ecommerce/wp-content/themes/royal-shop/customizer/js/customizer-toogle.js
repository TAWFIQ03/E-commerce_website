...
( function( $ ){
	...
	OPNControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'royal-shop-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'royal-shop-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'royal-shop-control-trigger.' + hook, callback );
	    },
	};
...
( function( $ ){
	...
	OPNCustomizer = {
		...
		_initToggles: function()
		{
			...
			OPNControlTrigger.triggerHook( 'royal-shop-toggle-control', api );
